function  validar()  {
    ...
    else if(fecha.test(caducidad)){
        document.getElementById("vcaducidad").innerHTML= "";
    }
    else{
        document.getElementById("vcaducidad").innerHTML= "Formato incorrecto";

    }
    if(cvv==''){
        document.getElementById("vcvv").innerHTML= "Este campo es obligatorio";
    }
    else if(vcvv.test(cvv)){
        document.getElementById("vcvv").innerHTML= "";
    }
    else{
        document.getElementById("vcvv").innerHTML= "Formato incorrecto";
